...
class GameBoard:
    ...
    def __init__(self, title, game, size, bkColor='Mediumblue', buttonColor='Tan'):
        ...
        taskHeight = 130 # height of task window where tasks are listed
        taskWidth = 426
        ...
        self.sound = Button(Point(buttonX + buttonWidth/2, buttonY+30 + lineSpace*2),
                           "Play Music", partial(self.do, self.game.play_sound), buttonColor)
        self.sound.draw(self.window)


        self.wayBack = Button(Point(buttonX + buttonWidth/2, buttonY + 16+ lineSpace*4),
