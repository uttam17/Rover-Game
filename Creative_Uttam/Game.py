...
class Game:
    ...
    def __init__(self):
        ...
        self.gui = GameBoard("Rebuild the Millenium Falcon", self, Game.SIZE)
        self.rover = Rover()
        ...
        self.rover_image = 'x-wing.ppm'
        self.audio_files = ['starwars.wav', 'imperial.wav', 'ewokparade.wav']
        winsound.PlaySound('hansolo.wav', winsound.SND_ALIAS | winsound.SND_ASYNC)
        ...
        if str(item) == "Part":
            ...
            if self._check_if_rover_on_item(item): # Rover on portal
                ...
                if item.linked_portal != None: # Portal is linked
                    ...
                    winsound.PlaySound('portal_sound.wav', winsound.SND_ALIAS | winsound.SND_ASYNC)
    ...
    def play_sound(self):
        """ Plays a choice of three star wars songs when called
        """
    ...
    def goDown(self):
        """ Called by GUI when button clicked. 
            ...
            on a portal, it will teleport. 
        """
        self.rover_image = 'x-wing_down.ppm'
    ...
    def goLeft(self):
        ...
        """
        self.rover_image = 'x-wing_left.ppm'
    ...
    def goRight(self):
        """ Called by GUI when button clicked. 
            ...
            on a portal, it will teleport. 
        """
        self.rover_image = 'x-wing_right.ppm'
    ...
    def help(self):
        """ Plays the sound of jabba laughing when called. There is no help in space.
        """
        winsound.PlaySound('jabbalaughing.wav', winsound.SND_ALIAS | winsound.SND_ASYNC)
        return
    ...
    def pickUp(self):
        ...
        if str(item) not in ['Ship Component', 'Portal', '0']:
            ...
            if item_name == 'Light Saber':
                winsound.PlaySound('saber.wav', winsound.SND_ALIAS | winsound.SND_ASYNC)
            elif item_name == 'R2 Droid':
                winsound.PlaySound('r2.wav', winsound.SND_ALIAS | winsound.SND_ASYNC)
            elif item_name == 'Blaster':
                winsound.PlaySound('blaster.wav', winsound.SND_ALIAS | winsound.SND_ASYNC)
    ...
    def getCurrentTask(self):
        ...
        if len(self.task_queue)==0:
            winsound.PlaySound('clear.wav', winsound.SND_ALIAS | winsound.SND_ASYNC)
    ...
    def _initialize_tasks(self):
        """ Enqueue's one task to the task queue. Always runs when game is initialized
        """
        
        self.task_queue.enqueue(Task())

    def _add_task(self):
        """ Adds a task through the enqueue method
        """
        self.task_queue.enqueue(Task())
...
class Part(Item): 
    ...
    def _set_image(self):
        ...
        choice = randint(1,5)
        if choice == 1:
            return 'Light Saber.ppm'
        elif choice == 2:
            return 'blaster.ppm'
        elif choice == 3:
            return 'R2 Droid.ppm'
        elif choice == 4:
            return 'Comm Link.ppm'
        elif choice == 5:
            return 'bacta Tank.ppm'
...
class ShipComponent(Item):
    ...
    def _set_image(self):
        ...
        if choice == 1:
            ...
            if broken_choice == 1:
                return 'helmetbroken.ppm'
            elif broken_choice == 2:
                return 'fuel_tankbroken.ppm'
            elif broken_choice == 3:
                return 'hullbroken.ppm'

    def toggle_broken(self):
        self.image = self.image[:-10] +'.ppm'
...
class Task:
    ...
    def _initialize_task(self):
        ...
        broken_part_list = ['You\'re out of fuel and the empire is hot on your tail! \nFix a fuel tank quick!\n', 'Found a stranded Jedi. He is the only \none that can lead you home. Get him a new helmet', 'We need to escape the planet before the \nempire destroys it. However we don\'t have a \ngood hull. Fix it!']
        text = broken_part_list[broken_part_index] + '\n' + "You will need to collect these items:"

        if broken_part_index == 0:
            self.broken_item = 'fuel_tankbroken.ppm'
        elif broken_part_index == 1:
            self.broken_item = 'helmetbroken.ppm'
        else:
            self.broken_item = 'hullbroken.ppm'
        item_list = ['Blaster', "Light Saber", "R2 Droid", "Comm Link", "Bacta Tank"]
